  ...
  return (
    <>
      ...
      <p>
        ...
        conservantes.
        <strong> Tienen mucho menos aire y mucha menos grasa</strong> (sólo 7%)
        incorporada. Su precio es considerablemente mayor que el del helado
        industrial, debido a la calidad y cantidad de los productos empleados,
        además de su producción a pequeña escala. Es un helado cremoso y con
        mucho más cuerpo que un helado industrial. Nutricionalmente nos aporta
        calcio, aminoácidos y vitaminas.
      </p>
      <h2>Helado Industrial</h2>
      <p>
        Son los helados elaborados en plantas industriales en cuya producción se
        usan colorantes y saborizantes para realzar su aspecto y sabor. El
        ...
        <strong>utilizan ingredientes de menor calidad</strong> y procedimientos
        como los siguientes: se sustituye la leche por sólido lácteo, la nata
        por grasa de coco, y sobre todo{" "}
